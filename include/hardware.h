...
SBIT(MBTN_LEFT, PORT2, 4);  // DB9 pin 6 = LEFT MOUSE BUTTON
SBIT(MBTN_RIGHT, PORT2, 6); // DB9 pin 9 = RIGHT MOUSE BUTTON

/* ST joystick aliases */
SBIT(JOY_UP, PORT2, 0);     // DB9 pin 1 = UP
SBIT(JOY_DOWN,  PORT2, 1);  // DB9 pin 2 = DOWN
SBIT(JOY_LEFT,  PORT2, 2);  // DB9 pin 3 = LEFT
